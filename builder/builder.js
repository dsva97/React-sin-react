...
var Link = ({ text, link }, key) => /* @__PURE__ */ React.createElement("a", {
...
var Component = ({ title, content, actions }) => /* @__PURE__ */ React.createElement("div", {
  className: "panel"
}, /* @__PURE__ */ React.createElement("h1", null, title), /* @__PURE__ */ React.createElement("p", null, content), /* @__PURE__ */ React.createElement("div", {
  className: "panel__actions"
}, actions.map(Link_default)));
var Panel_default = Component;

// src/components/Card/script.js
var cards = [...document.querySelectorAll("card")];
var handler = (e) => alert(e.target.querySelector("h1").texContent);
var setEvent = (card) => card.addEventListener("click", handler);
cards.forEach(setEvent);

// src/components/Card/index.jsx
var Card = ({ title, author, content, img }) => /* @__PURE__ */ React.createElement("article", {
  className: "card"
}, /* @__PURE__ */ React.createElement("header", null, /* @__PURE__ */ React.createElement("img", {
  src: img,
  alt: title
})), /* @__PURE__ */ React.createElement("main", null, /* @__PURE__ */ React.createElement("h1", null, title), /* @__PURE__ */ React.createElement("i", null, author), /* @__PURE__ */ React.createElement("p", null, content)));
...
var App = () => /* @__PURE__ */ React.createElement("div", {
  ...
  text: "Contact",
  href: "/contact"
}))), /* @__PURE__ */ React.createElement("main", null, /* @__PURE__ */ React.createElement("section", null, /* @__PURE__ */ React.createElement(Panel_default, null)), /* @__PURE__ */ React.createElement("section", null, /* @__PURE__ */ React.createElement(Card_default, {
  title: "Mongo DB",
  ...
  author: "Lenin",
  content: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Possimus culpa voluptatibus commodi, dignissimos numquam ullam."
}))), /* @__PURE__ */ React.createElement("footer", null, "Hecho con pasi\xF3n en Los Olivos, Lima - Per\xFA."));
var App_default = App;

// builder/constants.js
var import_path = __toModule(require("path"));
var DIST_PATH = import_path.default.resolve(__dirname, "..", "dist");
var STRING_PATH = import_path.default.resolve(DIST_PATH, "string.html");
var STATIC_PATH = import_path.default.resolve(DIST_PATH, "static.html");

// builder/index.jsx
var Html = () => /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("html", {
  lang: "en"
...
}), /* @__PURE__ */ import_react.default.createElement("title", null, "Document")), /* @__PURE__ */ import_react.default.createElement("body", null, /* @__PURE__ */ import_react.default.createElement("div", {
  id: "root"
}, /* @__PURE__ */ import_react.default.createElement(App_default, null)), /* @__PURE__ */ import_react.default.createElement("script", {
  src: "/bundle.js"
}))));
var string = import_server.default.renderToString(/* @__PURE__ */ import_react.default.createElement(Html, null));
var stringStatic = import_server.default.renderToStaticMarkup(/* @__PURE__ */ import_react.default.createElement(Html, null));
import_fs.default.writeFileSync(STRING_PATH, string);
import_fs.default.writeFileSync(STATIC_PATH, stringStatic);
/*
object-assign
(c) Sindre Sorhus
@license MIT
